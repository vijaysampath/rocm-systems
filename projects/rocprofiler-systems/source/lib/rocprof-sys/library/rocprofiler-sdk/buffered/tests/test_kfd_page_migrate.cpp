...
// on_kfd_page_migrate_configure<Externals> calls exactly these members
// unconditionally-or-conditionally (unlike the other kfd_* domains, it queries BOTH
// GPU and CPU agents and never early-returns); mocked so tests can verify it ran
...
// and on_kfd_page_migrate_configure. The on_records-only members
